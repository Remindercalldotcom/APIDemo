...
<input type="text" name="key" placeholder="Key"/><br>
<!-- Voice Call UniqueID -->
<input type="text" name="UniqueIDtext" placeholder="Call ID" />Enter YOUR unique id from a voice call.<br>
<!-- Text Message UniqueID -->
<input type="text" name="UniqueIDcall" placeholder="Text ID" />Enter YOUR unique id from a text message.<br>
